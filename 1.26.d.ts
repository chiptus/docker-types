...
export interface paths {
  ...
  "/containers/{id}/archive": {
    ...
    get: operations["ContainerGetArchive"];
    /**
     * Upload a tar archive to be extracted to a path in the filesystem of container id.
     * `path` parameter is asserted to be a directory. If it exists as a file, 400 error
     * will be returned with message "not a directory".
     */
    put: operations["ContainerPutArchive"];
    /** A response header `X-Docker-Container-Path-Stat` is return containing a base64 - encoded JSON object with some filesystem header information about the path. */
    head: operations["ContainerArchiveHead"];
  };
  "/containers/prune": {
...
export interface definitions {
  ...
  Image: {
    ...
    /** Format: int64 */
    VirtualSize?: number;
    GraphDriver?: definitions["GraphDriver"];
    RootFS?: {
      Type?: string;
      Layers?: string[];
    };
...
export interface operations {
  ...
  ContainerAttach: {
    parameters: {
      ...
      query: {
         ...
         */
        logs?: boolean;
        /** Stream attached streams from the the time the request was made onwards */
        stream?: boolean;
        /** Attach to `stdin` */
        stdin?: boolean;
        /** Attach to `stdout` */
  ...
  ImageDelete: {
    ...
    responses: {
      /** No error */
      200: {
        schema: definitions["ImageDeleteResponse"][];
      };
      /** No such image */
      404: {
        schema: definitions["ErrorResponse"];
    ...
    responses: {
      ...
      200: {
        schema: {
          ...
          ImagesDeleted?: definitions["ImageDeleteResponse"][];
          /**
           * Format: int64
           * @description Disk space reclaimed in bytes
           */
  ...
  ServiceCreate: {
    ...
    responses: {
      ...
      /** server error or node is not part of a swarm */
      503: {
        schema: definitions["ErrorResponse"];
      };
    };
